...
/**
 * The class HelpDialog is an extension of JDialog that permits to show a dialog
 * when the user clicks on the help menu item.
 */
public class HelpDialog extends JDialog {
    ...
    /**
     * HelpDialog(VisualisationJFrame f) is the main constructor of this class.
     * It creates all the elements relative to the dialog.
     * 
     * @param f
     *            : The main frame
     */
